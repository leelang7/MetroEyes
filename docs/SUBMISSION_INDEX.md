...
| 10 | **9 공공 API 활용** | citydata_ppltn (110 POI 분단위) · CardSubway · TOPIS · 공공데이터포털 등 | README.md §"Data Sources" |
...
| 점수 | 항목 | 산출물 |
|---:|---|---|
| 4 | **164 회귀 가드 + CI 15 jobs** | tests/ + .github/workflows/ci.yml |
