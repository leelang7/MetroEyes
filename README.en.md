...
[![Tests](https://img.shields.io/badge/regression_tests-15_guards-10b981.svg)](tests/)
...
- ✅ **CI 7 jobs + 15 pytest regression guards** (cycle 318-322): OpenAPI spec(4) + ROI v3 KPI(5) + dispersion EDA(6) — keeps advertised numbers and code in sync
