...
[![Tests](https://img.shields.io/badge/regression_tests-21회귀_가드-10b981.svg)](tests/)
...
- ✅ **CI 8 jobs + pytest 회귀 가드 21건** (cycle 318-326): OpenAPI spec(4) + ROI v3 KPI(5) + dispersion EDA(6) + OD/transfer EDA(6) — README 광고 수치(삼성 12.4x / 충무로 +1.56 / 연신내 +1.44 등)와 코드 분리 자동 방지
