...
[![Tests](https://img.shields.io/badge/regression_tests-522회귀_가드-10b981.svg)](tests/)
...
make verify       # ship-gate 10/10 + pytest 522 가드 (10초)
...
2호선 ROI 708x — 정책 결정 즉답. 8단 fail-safe + 522 회귀 가드 + 4 언어 i18n production-grade.
