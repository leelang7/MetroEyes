...
[![Cycles](https://img.shields.io/badge/자동_사이클-473회-a78bfa.svg)](CHANGELOG.md)
...
make verify       # ship-gate 10/10 + pytest 337 가드 (10초)
...
2호선 ROI 708x — 정책 결정 즉답. 8단 fail-safe + 337 회귀 가드 + 4 언어 i18n production-grade.
