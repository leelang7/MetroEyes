...
[![Cycles](https://img.shields.io/badge/자동_사이클-325회-a78bfa.svg)](CHANGELOG.md)
...
[![Tests](https://img.shields.io/badge/regression_tests-27회귀_가드-10b981.svg)](tests/)
...
- ✅ **CI 9 jobs + pytest 회귀 가드 27건** (cycle 318-327): OpenAPI spec(4) + ROI v3 KPI(5) + dispersion EDA(6) + OD/transfer EDA(6) + bonus_krw tier(6) — README 광고 수치(삼성 12.4x / 충무로 +1.56 / 연신내 +1.44 / 차등 보상 ₩100~₩400) + 코드 정확성 자동 방지
