...
### 신규 자료 (8 종)
- `frontend/onepager.html` (cycle 372/377/495) — A4 1-Pager 4언어
...
## v6.11 — D-2 회귀 가드 495건 + mobile_app Flutter + 시민신고 오프라인큐 + admin 시민신고LIVE + op/admin citizen_report + 8-Moat + i18n4언어 (2026-05-11 cycle 469-496)

### v6.11 cycle 495-496
- cycle 495: op/admin citizen_report 핸들러(applyCitizenReport) + 341→342 가드 전체 동기화
- cycle 496: passenger_app FAB 상태 머신 (스피너/_setReportBtnState/_updateQueueBadge/오프라인배지) + 342→495 가드 동기화
...
- cycle 495: SLIDES 시민신고·10공공API·ESG 가드 3건 추가
...
## v6.8 — D-4 회귀 가드 273건 + 30p 상세기획서 deck + citydata 통합 + 3D OpenFreeMap + dday.ps1/sh/Makefile + link checker + ad env + FORM_DATA + cycle 374 회복 (2026-05-08~09 cycle 391-495)

### v6.8 cycle 414-495 (3rd platform parity + install + Quick Start + body drift + 3D map + citydata fetch + 30p deck)
...
- cycle 495: 📑 **30 슬라이드 상세기획서 HTML deck** (사용자 직접 지시 — PPT 템플릿 → HTML 30p)
  ...
  - canonical KPI 7종 (1,393억/495×/473.4M/157M/708×/CI [1,064~1,808]) 모두 포함 — drift 차단
...
- cycle 400: 🎉 마일스톤 — 자동 모드 400 사이클 완주 + onepager 197/495 → 233/400
...
- cycle 389: onepager stale 146/377 → 197/495 갱신
...
- **cycle 369** 5분 발표 영상 4언어 narration 스크립트
  ...
  - cycle 356/358/495 신규 KPI 모두 4언어 노출
